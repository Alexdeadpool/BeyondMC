...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Ears = partdefinition.addOrReplaceChild("Ears",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -31.0F, -1.0F, 4.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(4.0F, -31.0F, -1.0F, 4.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
