...
public class RedcoatRenderer extends HumanoidMobRenderer<RedcoatEntity, HumanoidModel<RedcoatEntity>> {
	...
	public ResourceLocation getTextureLocation(RedcoatEntity entity) {
		return new ResourceLocation("beyondmc:textures/entities/redcoatskin.png");
	}
}
